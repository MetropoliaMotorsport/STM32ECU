...
// #define PROCESSLOOPTIME 		10   // should be 100 for 10ms in normal operation, bigger number for
// slower main loop in testing. - 50?
...
typedef struct
{
  uint8_t MaxOutputPower; // Max output power of the car in kw. Maximum total Power that inverters
                          // can output.
