...
volatile CarConfigType CarConfig;
...
static int HardwareInit(void)
{
  ...
  vTaskDelay(50); // delay to allow debugger to hopefully latch. // have some input pin act as a
                  // boot stopper.
...
int realmain(void)
{
  ...
  MainTaskTaskHandle =
      xTaskCreateStatic(MainTask, MAINTASKTASKNAME, MAINTASKSTACK_SIZE, (void*)1,
