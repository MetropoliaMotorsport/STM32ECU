...
bool processIVTMsgData(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);

bool processIVTIData(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTU1Data(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTU2Data(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTU3Data(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTTData(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTWData(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTAsData(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIVTWhData(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
...
CANData IVTCan[8] = { { &DeviceState.IVT, IVTBase_ID, 6, processIVTIData,
		IVTTimeout, IVTTIMEOUT }, { &DeviceState.IVT, IVTBase_ID + 1, 6,
		processIVTU1Data, NULL, 0 }, { &DeviceState.IVT, IVTBase_ID + 2, 6,
		processIVTU2Data, NULL, 0 }, { &DeviceState.IVT, IVTBase_ID + 3, 6,
		processIVTU3Data, NULL, 0 }, { &DeviceState.IVT, IVTBase_ID + 4, 6,
		processIVTTData, NULL, 0 }, { &DeviceState.IVT, IVTBase_ID + 5, 6,
		processIVTWData, NULL, 0 }, { &DeviceState.IVT, IVTBase_ID + 6, 6,
		processIVTAsData, NULL, 0 }, { &DeviceState.IVT, IVTBase_ID + 7, 6,
		processIVTWhData, NULL, 0 } };
...
bool processIVTData(const uint8_t *CANRxData, const uint32_t DataLength,
		const uint16_t field) {
	if (DeviceState.IVTEnabled) {
		long value = CANRxData[2] * 16777216 + CANRxData[3] * 65536
				+ CANRxData[4] * 256 + CANRxData[5];
