...
bool processIMUStatus(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUUTC(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUInfo(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUAccel(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUGyro(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUDeltaV(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUDeltaA(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUEuler(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUVel(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
// bool processIMUVelAcc( const uint8_t CANRxData[8], const uint32_t DataLength, CANData *
// datahandle );
bool processIMUVelBody(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUGPS(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
bool processIMUGPSVel(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle);
...
// };
CANData IMUVelBody = {&DeviceState.IMU,  IMUVELBody_ID, 6,
                      processIMUVelBody, IMUTimeout,    IMUTIMEOUT};
...
bool processIMUInfo(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle)
{
  ...
  )
  {
    ...
    IMUReceived.Temperature = getLEint16(&CANRxData[6]);
...
#ifdef IMUNONUSED
bool processIMUVelAcc(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle)
{
  if (true // verify data format.
  )
  {
...
bool processIMUAUTO(const uint8_t CANRxData[8], const uint32_t DataLength, CANData* datahandle)
{
  if (true // verify data format.
  )
  {
