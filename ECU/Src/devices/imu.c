...
bool processIMUStatus(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUUTC(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUInfo(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUAccel(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUGyro(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUDeltaV(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUDeltaA(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUEuler(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUVel(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
//bool processIMUVelAcc( const uint8_t CANRxData[8], const uint32_t DataLength, const CANData * datahandle );
bool processIMUVelBody(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
bool processIMUGPS(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle);
...
bool processIMUVel(const uint8_t CANRxData[8], const uint32_t DataLength,
	...
	if ( true // verify data format.
		...
		IMUReceived.VelMag = sqrt(
				pow(IMUReceived.VelE, 2) + pow(IMUReceived.VelE, 2));
...
bool processIMUAUTO(const uint8_t CANRxData[8], const uint32_t DataLength,
		const CANData *datahandle) {
	if ( true // verify data format.
	) {
		//0x177
