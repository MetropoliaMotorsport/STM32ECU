...
#define TORQUEMENUSIZE			(TORQUEMENU_LAST+1)
	...
	doMenuBoolEdit( MenuLines[1+TORQUEMENU_VECTORING], "TCS RPM", (menu.selection==TORQUEMENU_WHEELS), &menu.inedit, &getEEPROMBlock(0)->TorqueVectoring, TORQUE_TCSENABLEDBIT, input);
