...
#ifdef HPF20
OutputType Output[OUTPUTCount] = { { DO1_GPIO_Port, DO1_Pin }, { DO2_GPIO_Port,
DO2_Pin }, { DO3_GPIO_Port, DO3_Pin }, { DO4_GPIO_Port, DO4_Pin }, {
DO5_GPIO_Port, DO5_Pin }, { DO6_GPIO_Port, DO6_Pin }, { DO7_GPIO_Port,
DO7_Pin }, { DO11_GPIO_Port, DO11_Pin }, { DO12_GPIO_Port, DO12_Pin }, {
DO13_GPIO_Port, DO13_Pin }, { DO14_GPIO_Port, DO14_Pin },
#ifndef HPF2023
		 { DO15_GPIO_Port, DO15_Pin},
#endif
		{ LD7_GPIO_Port, LD7_Pin }, { LD8_GPIO_Port, LD8_Pin }, { LD9_GPIO_Port,
		LD9_Pin }, { LD0_GPIO_Port, LD0_Pin }, { LD1_GPIO_Port, LD1_Pin }, {
				LD3_GPIO_Port, LD3_Pin }, { LD4_GPIO_Port,
		LD4_Pin } };
#endif
...
void updateOutput(output output) {
	...
	if (Output[output].blinkstate > On
			&& Output[output].blinkstate != Nochange) {
		int ontime = 0;
		int offtime = 0;
		...
		if ((xBlinkHandle[output] == NULL
				|| eTaskGetState(xBlinkHandle[output]) == eDeleted)
				&& Output[output].time > 0) {
			xBlinkHandle[output] = xTaskCreateStatic(BlinkTask, /* Function that implements the task. */
		...
		} else if (Output[output].time > 0
				&& eTaskGetState(xBlinkHandle[output]) == eSuspended) {
...
int initOutput(void) {
	OutputQueue = xQueueCreateStatic(OutputQUEUE_LENGTH, OutputITEMSIZE,
			OutputQueueStorageArea, &OutputStaticQueue);

	vQueueAddToRegistry(OutputQueue, "OutputQueue");

	OutputTaskHandle = xTaskCreateStatic(OutputTask,
	OUTPUTTASKNAME,
	OUTPUTSTACK_SIZE, (void*) 1,
	OUTPUTTASKPRIORITY, xOUTPUTStack, &xOUTPUTTaskBuffer);
